...
def pandora_setup(pandora_ctx: PandoraContext, binary_path: Path):
    ...
    with Live(console_progress, console=console):
        ...
        task_hooker = console_progress.add_task(description=f'Hooking Sancus-specific instructions', total=None)
        ...
        # Creates blank angr state with pandora_options.py set
        ...
        hooker.HookerManager(init_state, live_console=console_progress, task=task_hooker)

        # Simulate enter routine on the init_state
        eenter(init_state)
