...
class Reporter(metaclass=Singleton):
    def __init__(self, binary='', sdk_name='auto', reporter_level=LogLevel.INFO):
        ...
        enclave_range = get_enclave_range()
        enclave_min_text = enclave_range['min_addr_text']
        enclave_max_text = enclave_range['max_addr_text']
        enclave_min_data = enclave_range['min_addr_data']
        enclave_max_data = enclave_range['max_addr_data']
        ...
        metadata = {
            ...
            "sdk": sdk_name,
            "enclave_range" : f'[Text: {enclave_min_text:#x}, {enclave_max_text:#x}; Data: {enclave_min_data:#x}, {enclave_max_data:#x}]'
        }
