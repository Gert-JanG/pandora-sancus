...
class SimUnprotect(SimProcedure):
    def run(self, opstr='', bytes_to_skip=2, **kwargs):
        ...
        logger.debug('hooking sancus_disable, 0x1380 ---> NOT IMPLEMENTED')
...
class SimProtect(SimProcedure):
    def run(self, opstr='', bytes_to_skip=2, **kwargs):
        logger.debug('hooking sancus_enable, 0x1381 ---> NOT IMPLEMENTED')
        self.jump(self.state.addr + bytes_to_skip)
...
class SimAttest(SimProcedure):
    def run(self, opstr='', bytes_to_skip=2, **kwargs):
        logger.debug('hooking verify_address, 0x1382 ---> NOT IMPLEMENTED')
        self.jump(self.state.addr + bytes_to_skip)
...
class SimEncrypt(SimProcedure):
    def run(self, opstr='', bytes_to_skip=2, **kwargs):
        logger.debug(f'hooking sancus_encrypt at {hex(self.state.addr)}, 0x1384 ---> NOT IMPLEMENTED')
        self.jump(self.state.addr + bytes_to_skip)
...
class SimDecrypt(SimProcedure):
    def run(self, opstr='', bytes_to_skip=2, **kwargs):
        logger.debug(f'hooking sancus_decrypt at {hex(self.state.addr)}, 0x1385 ---> NOT IMPLEMENTED')
